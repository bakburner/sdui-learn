---
name: SDUI Prototype Backend Architect
...
<!-- Thin wrapper — canonical content lives in prompts/agents/ -->

Read and follow the full agent instructions from `prompts/agents/backend-architect.agent.md`.
