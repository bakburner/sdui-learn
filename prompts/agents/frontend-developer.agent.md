...
- **Section renderers** (`web/src/components/sections/`): `BoxscoreTable`, `GamePanel`, `FormRenderer`, `TabGroup`, `SeasonLeadersTable`, `SubscribeHero`, `SubscribeBanner`, `AdSlot` — each owns its internal state.
