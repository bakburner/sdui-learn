...
struct SduiModels: Codable {
    let action: Action?
    let actionTrigger: ActionTrigger?
    let actionType: ActionType?
    let adSlot: AdSlot?
    let alignment: Alignment?
    let atomicComposite: AtomicComposite?
    let atomicElement: AtomicElement?
    let boxscoreTable: BoxscoreTable?
    let calendarMonthList: CalendarMonthList?
    let calendarStrip: CalendarStrip?
    let crossAlignment: CrossAlignment?
    let dataBinding: DataBinding?
    let dataBindingPath: DataBindingPath?
    let direction: AtomicElementDirection?
    let form: Form?
    ...
    let screen: Screen?
    let seasonLeadersTable: SeasonLeadersTable?
    let section: Section?
    let spacing: Spacing?
    let state: [String: JSONAny]?
    let subscribeUpsell: SubscribeUpsell?
...
extension SduiModels {
    ...
    func with(
        action: Action?? = nil,
        actionTrigger: ActionTrigger?? = nil,
        actionType: ActionType?? = nil,
        adSlot: AdSlot?? = nil,
        alignment: Alignment?? = nil,
        atomicComposite: AtomicComposite?? = nil,
        atomicElement: AtomicElement?? = nil,
        boxscoreTable: BoxscoreTable?? = nil,
        calendarMonthList: CalendarMonthList?? = nil,
        calendarStrip: CalendarStrip?? = nil,
        crossAlignment: CrossAlignment?? = nil,
        dataBinding: DataBinding?? = nil,
        dataBindingPath: DataBindingPath?? = nil,
        direction: AtomicElementDirection?? = nil,
        form: Form?? = nil,
        imageFit: ImageFit?? = nil,
        navigation: Navigation?? = nil,
        navigationItem: NavigationItem?? = nil,
        refreshPolicy: RefreshPolicy?? = nil,
        refreshType: RefreshType?? = nil,
        screen: Screen?? = nil,
        seasonLeadersTable: SeasonLeadersTable?? = nil,
        section: Section?? = nil,
        spacing: Spacing?? = nil,
        state: [String: JSONAny]?? = nil,
        subscribeUpsell: SubscribeUpsell?? = nil,
        subscriptionTier: SubscriptionTier?? = nil,
        subsection: Subsection?? = nil,
        tabData: TabData?? = nil,
        tabGroup: TabGroup?? = nil,
        textVariant: TextVariant?? = nil,
        textWeight: TextWeight?? = nil,
        videoPlayer: VideoPlayer?? = nil
    ) -> SduiModels {
        return SduiModels(
            action: action ?? self.action,
            actionTrigger: actionTrigger ?? self.actionTrigger,
            actionType: actionType ?? self.actionType,
            adSlot: adSlot ?? self.adSlot,
            alignment: alignment ?? self.alignment,
            atomicComposite: atomicComposite ?? self.atomicComposite,
            atomicElement: atomicElement ?? self.atomicElement,
            boxscoreTable: boxscoreTable ?? self.boxscoreTable,
            calendarMonthList: calendarMonthList ?? self.calendarMonthList,
            calendarStrip: calendarStrip ?? self.calendarStrip,
            crossAlignment: crossAlignment ?? self.crossAlignment,
            dataBinding: dataBinding ?? self.dataBinding,
            dataBindingPath: dataBindingPath ?? self.dataBindingPath,
            direction: direction ?? self.direction,
            form: form ?? self.form,
            imageFit: imageFit ?? self.imageFit,
            navigation: navigation ?? self.navigation,
            navigationItem: navigationItem ?? self.navigationItem,
            refreshPolicy: refreshPolicy ?? self.refreshPolicy,
            refreshType: refreshType ?? self.refreshType,
            screen: screen ?? self.screen,
            seasonLeadersTable: seasonLeadersTable ?? self.seasonLeadersTable,
            section: section ?? self.section,
            spacing: spacing ?? self.spacing,
            state: state ?? self.state,
            subscribeUpsell: subscribeUpsell ?? self.subscribeUpsell,
            subscriptionTier: subscriptionTier ?? self.subscriptionTier,
            subsection: subsection ?? self.subsection,
            tabData: tabData ?? self.tabData,
            tabGroup: tabGroup ?? self.tabGroup,
            textVariant: textVariant ?? self.textVariant,
...
struct AdSlot: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case adUnitPath, collapseOnEmpty, label, placeholder, provider
        case refreshIntervalSEC = "refreshIntervalSec"
        case sizes, targeting
    }
}

// MARK: AdSlot convenience initializers and mutators

extension AdSlot {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(AdSlot.self, from: data)
    }
...
// MARK: - AtomicComposite
struct AtomicComposite: Codable {
...
// MARK: AtomicComposite convenience initializers and mutators

extension AtomicComposite {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(AtomicComposite.self, from: data)
    }
...
// MARK: SectionData convenience initializers and mutators

extension SectionData {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(SectionData.self, from: data)
    }
...
enum AtomicElementDirection: String, Codable {
    case column = "column"
    case row = "row"
}
...
struct BoxscoreTable: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case columns, emptyMessage, players, sortDirectionStateKey, sortStateKey, teamColor
        case teamLogoURL = "teamLogoUrl"
        case teamName, teamTotals, teamTricode
    }
}

// MARK: BoxscoreTable convenience initializers and mutators

extension BoxscoreTable {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(BoxscoreTable.self, from: data)
    }
...
/// are ET-anchored (America/New_York) ISO YYYY-MM-DD. defaultDate is the league's current
/// anchor date; drives the 'today' visual highlight and the initial scroll position.
// MARK: - CalendarMonthList
struct CalendarMonthList: Codable {
    /// Map of ISO date string to metadata for that date. Only dates with games are present;
    /// absent dates have zero games.
    let dateMetadata: [String: DateMetadatum]?
    /// ISO YYYY-MM-DD (ET) for the league's current anchor date.
...
// MARK: CalendarMonthList convenience initializers and mutators

extension CalendarMonthList {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(CalendarMonthList.self, from: data)
    }
...
// MARK: CalendarStrip convenience initializers and mutators

extension CalendarStrip {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(CalendarStrip.self, from: data)
    }
...
/// Sortable, paginated table of season statistical leaders (league-wide)
// MARK: - SeasonLeadersTable
struct SeasonLeadersTable: Codable {
    /// Ordered column definitions; clients render left-to-right
    let columns: [BoxscoreColumnDefinition]
    /// Text shown when no player rows are available
    let emptyMessage: String?
...
// MARK: SeasonLeadersTable convenience initializers and mutators

extension SeasonLeadersTable {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(SeasonLeadersTable.self, from: data)
    }
...
/// One ranked player row in a season leaders table
// MARK: - LeadersPlayerRow
struct LeadersPlayerRow: Codable {
    let actions: [Action]?
    let imageURL: String?
    /// Display name, e.g. 'Luka Dončić'
    let name: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case name
        case playerID = "playerId"
        case rank, stats, team
    }
}

// MARK: LeadersPlayerRow convenience initializers and mutators

extension LeadersPlayerRow {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(LeadersPlayerRow.self, from: data)
    }
...
/// action. Layout intent (inline banner vs. full-screen hero) is expressed by the inner `ui`
/// atomic tree and the section's outer `surface`, not by component identity.
// MARK: - SubscribeUpsell
struct SubscribeUpsell: Codable {
    /// Optional top-level fallback action invoked when the IAP SDK is not mounted (today, always
    /// for inline banner uses; full-screen hero uses typically rely on per-tier CTAs inside
    /// `ui`).
    let ctaAction: Action?
...
// MARK: SubscribeUpsell convenience initializers and mutators

extension SubscribeUpsell {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(SubscribeUpsell.self, from: data)
    }
...
// MARK: TabGroup convenience initializers and mutators

extension TabGroup {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(TabGroup.self, from: data)
    }
...
struct VideoPlayer: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case autoplay, capabilities
        case contentID = "contentId"
        case displayConfig, playerType, ui
    }
}

// MARK: VideoPlayer convenience initializers and mutators

extension VideoPlayer {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(VideoPlayer.self, from: data)
    }
