...
val mapper = jacksonObjectMapper().apply {
    ...
    convert(AtomicElementDirection::class, { AtomicElementDirection.fromValue(it.asText()) }, { "\"${it.value}\"" })
...
data class SduiModels (
    ...
    val actionTrigger: ActionTrigger? = null,
    val actionType: ActionType? = null,
    val adSlot: AdSlot? = null,
    val alignment: Alignment? = null,
    val atomicComposite: AtomicComposite? = null,
    val atomicElement: AtomicElement? = null,
    val boxscoreTable: BoxscoreTable? = null,
    val calendarMonthList: CalendarMonthList? = null,
    val calendarStrip: CalendarStrip? = null,
    val crossAlignment: CrossAlignment? = null,
    val dataBinding: DataBinding? = null,
    val dataBindingPath: DataBindingPath? = null,
    val direction: AtomicElementDirection? = null,
    val form: Form? = null,
    val imageFit: ImageFit? = null,
    val navigation: Navigation? = null,
    val navigationItem: NavigationItem? = null,
    val refreshPolicy: RefreshPolicy? = null,
    val refreshType: RefreshType? = null,
    val screen: Screen? = null,
    val seasonLeadersTable: SeasonLeadersTable? = null,
    val section: Section? = null,
    val spacing: Spacing? = null,
    val state: Map<String, Any?>? = null,
    val subscribeUpsell: SubscribeUpsell? = null,
    val subscriptionTier: SubscriptionTier? = null,
    val subsection: Subsection? = null,
    val tabData: TabData? = null,
    val tabGroup: TabGroup? = null,
    val textVariant: TextVariant? = null,
...
enum class AtomicElementDirection(val value: String) {
    Column("column"),
    Row("row");

    companion object {
        fun fromValue(value: String): AtomicElementDirection = when (value) {
            "column" -> Column
            "row"    -> Row
            else     -> throw IllegalArgumentException()
        }
 ...
 * Typed tabular data for an NBA-style boxscore (one per team)
 */
data class BoxscoreTable (
    /**
     * Ordered list of column definitions; clients render left-to-right
     */
    @get:JsonProperty(required=true)@field:JsonProperty(required=true)
    val columns: List<BoxscoreColumnDefinition>,
     ...
     */
    @get:JsonProperty(required=true)@field:JsonProperty(required=true)
    val players: List<BoxscorePlayerRow>,
...
data class SeasonLeadersTable (
     ...
     */
    @get:JsonProperty(required=true)@field:JsonProperty(required=true)
    val players: List<LeadersPlayerRow>,
 ...
 */
enum class TextVariant(val value: String) {
    BodyLarge("bodyLarge"),
    ...
    companion object {
        fun fromValue(value: String): TextVariant = when (value) {
            "bodyLarge"      -> BodyLarge
            "bodyMedium"     -> BodyMedium
            "bodySmall"      -> BodySmall
            "displayLarge"   -> DisplayLarge
...
data class VideoPlayer (
     ...
     * for event, streamUrl for stream). Single field avoids mutually exclusive optional IDs.
     */
    @get:JsonProperty("contentId", required=true)@field:JsonProperty("contentId", required=true)
