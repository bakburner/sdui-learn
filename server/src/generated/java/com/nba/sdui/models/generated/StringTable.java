...
public class StringTable {
    ...
    public StringTable withAdditionalProperty(String name, String value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StringTable.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StringTable) == false) {
            return false;
        }
        StringTable rhs = ((StringTable) other);
