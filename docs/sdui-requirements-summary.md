...
| Date | Summary |
|---|---|
| 2026-05-27 | Doc consistency audit. Dual-layer type model: section count 10 → 11 with `CalendarMonthList` added to the permanent-with-renderer list. Android, Web, iOS renderer-status rows updated 9 → 10 semantic section renderers/views. |
